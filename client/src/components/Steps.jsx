...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 x1:py-40'>
            <h1 className='text-center text-2x1 md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'> Steps to remove background <br /> image in seconds </h1>
